    ...
    <Layout>
      ...
      <div className="bg-ela-gray py-12">
        <div className="container-custom">
          <h1 className="text-3xl md:text-4xl font-bold mb-4 text-center text-ela-purpleb">
      ...
      <section className="section bg-ela-purpleb">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-white">Para quem procura serviços</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
            <div>
              <div className=" p-6 rounded-xl relative mb-8 bg-ela-gray">
                ...
                <h3 className="font-bold text-xl mb-3 text-ela-purpleb">Busque o serviço que você precisa</h3>
              ...
              <div className="bg-ela-gray p-6 rounded-xl relative">
                ...
                <h3 className="font-bold text-xl mb-3 text-ela-purpleb">Compare perfis de prestadoras</h3>
                <p className="text-gray-700">
            ...
            <div>
              <div className="bg-ela-gray p-6 rounded-xl relative mb-8">
                ...
                <h3 className="font-bold text-xl mb-3 text-ela-purpleb">Entre em contato e contrate</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-ela-gray p-6 rounded-xl relative">
                ...
                <h3 className="font-bold text-xl mb-3 text-ela-purpleb">Avalie após o serviço</h3>
                <p className="text-gray-700">
          ...
          <div className="text-center">
            <Link to="/cadastro">
              <Button className="bg-ela-gray hover:bg-ela-purple/90 text-ela-purpleb rounded-full px-8 py-6 text-lg">
      ...
      <section className="section bg-ela-gray">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-ela-purpleb">Para prestadoras de serviços</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
            <div>
              <div className="bg-white p-6 rounded-xl shadow-sm relative mb-8">
                <span className="absolute -top-5 -left-5 w-12 h-12 bg-ela-pink text-ela-gray rounded-full flex items-center justify-center font-bold text-xl">1</span>
                <h3 className="font-bold text-xl mb-3 text-ela-purpleb">Crie seu perfil profissional</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm relative">
                <span className="absolute -top-5 -left-5 w-12 h-12 bg-ela-pink text-ela-gray rounded-full flex items-center justify-center font-bold text-xl">2</span>
                <h3 className="font-bold text-xl mb-3 text-ela-purpleb">Passe pela verificação</h3>
                <p className="text-gray-700">
            ...
            <div>
              <div className="bg-white p-6 rounded-xl shadow-sm relative mb-8">
                <span className="absolute -top-5 -left-5 w-12 h-12 bg-ela-pink text-ela-gray rounded-full flex items-center justify-center font-bold text-xl">3</span>
                <h3 className="font-bold text-xl mb-3 text-ela-purpleb">Receba solicitações e contatos</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm relative">
                <span className="absolute -top-5 -left-5 w-12 h-12 bg-ela-pink text-ela-gray rounded-full flex items-center justify-center font-bold text-xl">4</span>
                <h3 className="font-bold text-xl mb-3 text-ela-purpleb">Cresça seu negócio</h3>
                <p className="text-gray-700">
          ...
          <div className="text-center">
            <Link to="/seja-prestadora">
              <Button className="bg-ela-pink hover:bg-ela-pink/90 text-ela-white rounded-full px-8 py-6 text-lg">
      ...
      <section className="section bg-ela-purpleb">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-ela-white">Perguntas Frequentes</h2>
            <p className="text-gray-700 max-w-2xl mx-auto text-ela-gray">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="mb-6 bg-white p-6 rounded-xl shadow-sm">
              <h3 className="font-bold text-xl mb-2 text-ela-purpleb">O uso da plataforma é gratuito?</h3>
              <p className="text-gray-700">
            ...
            <div className="mb-6 bg-white p-6 rounded-xl shadow-sm">
              <h3 className="font-bold text-xl mb-2 text-ela-purpleb">Como garantem a segurança das usuárias?</h3>
              <p className="text-gray-700">
            ...
            <div className="mb-6 bg-white p-6 rounded-xl shadow-sm">
              <h3 className="font-bold text-xl mb-2 text-ela-purpleb">Posso contratar serviços em qualquer cidade?</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <h3 className="font-bold text-xl mb-2 text-ela-purpleb">O que fazer se tiver algum problema com o serviço?</h3>
              <p className="text-gray-700">
