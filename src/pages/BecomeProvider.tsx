...
const BecomeProvider = () => {
  return (
    <Layout>
      {/* Header da página */}
      <div className="bg-gradient-to-r from-ela-pink to-ela-lilac py-16">
      ...
      <section className="section bg-ela-gray">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">Por que se cadastrar no Ela Resolve?</h2>
            ...
            {benefits.map((benefit, index) => (
              <div key={index} className="flex items-start">
                <div className="bg-ela-lilac rounded-full p-2 mr-4 mt-1">
                  <Check className="text-ela-purple" size={16} />
                </div>
      ...
      <section className="section bg-ela-lilac">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">Como funciona para prestadoras</h2>
            <p className="text-gray-700 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <Card className="border-none shadow-sm bg-ela-gray">
              <CardContent className="p-6 text-center">
                <div className="w-12 h-12 bg-ela-pink rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="font-bold">1</span>
                </div>
                <h3 className="font-bold text-lg mb-2">Crie seu perfil</h3>
            ...
            <Card className="border-none shadow-sm bg-ela-gray">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-bold text-lg mb-2 ">Verificação</h3>
                <p className="text-gray-600">
            ...
            <Card className="border-none shadow-sm bg-ela-gray">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-bold text-lg mb-2">Apareça nas buscas</h3>
                <p className="text-gray-600">
            ...
            <Card className="border-none shadow-sm bg-ela-gray">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-bold text-lg mb-2">Receba solicitações</h3>
                <p className="text-gray-600">
      ...
      <section className="section bg-ela-lilac">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">O que nossas prestadoras dizem</h2>
            <p className="text-gray-700 max-w-2xl mx-auto">
            ...
            <Card className="border-none shadow-md bg-ela-gray">
              <CardContent className="p-6">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h3 className="font-semibold">Carla Mendes</h3>
      ...
      {/* Call to Action */}
      <section className="py-16 bg-ela-purple text-white">
